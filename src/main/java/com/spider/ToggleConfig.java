 ...
 * <p/>
 * 变换本地和线上配置，所有配置需要通过运行此类进行更改，不推荐手动更改，极易出错
 *
 * @author wsy
 */
public class ToggleConfig {
    ...
    public static void main(String[] args) throws IOException {
        ...
        toggleConfigPropertiesClass();
        toggleAppConfigClass();
        toggleConfigPropertiesFile();
    }

    private static void toggleConfigPropertiesFile() throws IOException {
    ...
    private static void toggleAppConfigClass() throws IOException {
    ...
    private static void toggleConfigPropertiesClass() throws IOException {

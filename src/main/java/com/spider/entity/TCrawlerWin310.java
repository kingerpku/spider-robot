...
public class TCrawlerWin310 implements java.io.Serializable {
     ...
     * 是否有单关的比赛
     *
     * @see com.spider.global.SingleState
     */
    private String singleState = SingleState.No.value();
    ...
    public boolean equals(Object obj) {
        ...
        if (startDateTime == null) {
            if (other.startDateTime != null)
                return false;
        } else if (!(startDateTime.getTime() == other.getStartDateTime().getTime()))
            return false;
        if (startTime == null) {
        ...
        if (stopSaleTime == null) {
            if (other.stopSaleTime != null)
                return false;
        } else if (!(stopSaleTime.getTime() == other.stopSaleTime.getTime()))
            return false;
    ...
    public boolean isDurationTimeChanged(TCrawlerWin310 win310) {

        return !this.durationTime.equals(win310.getDurationTime());
    }

    public boolean isRedCardChanged(TCrawlerWin310 win310) {

        return this.homeRedCard != win310.getHomeRedCard() || this.guestRedCard != win310.getGuestRedCard();
    }

    public boolean isScoreChanged(TCrawlerWin310 win310) {

        return !this.score.equals(win310.getScore());
    }

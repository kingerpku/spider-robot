 ...
 */
@Entity
@Table(name = "highlow_odds")
public class HiloOdds implements java.io.Serializable {
    ...
    public HiloOdds from(HiloOddsHistory hlOddsHistory) {

        this.win310Id = hlOddsHistory.getWin310Id();
        this.gamingCompany = hlOddsHistory.getGamingCompany();
        this.oddsHigh = hlOddsHistory.getOddsHigh();
        this.oddsLow = hlOddsHistory.getOddsLow();
        this.handicapLine = hlOddsHistory.getHandicapLine();
        this.updateTime = hlOddsHistory.getUpdateTime();
        this.oddsUpdateTime = hlOddsHistory.getOddsUpdateTime();
        this.state = hlOddsHistory.getState();
        this.score = hlOddsHistory.getScore();
        this.durationTime = hlOddsHistory.getDurationTime();
        this.homeRedCard = hlOddsHistory.getHomeRedCard();
        this.awayRedCard = hlOddsHistory.getAwayRedCard();
        this.europeId = hlOddsHistory.getEuropeId();
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        HiloOdds hiloOdds = (HiloOdds) o;

        if (gamingCompany != null ? !gamingCompany.equals(hiloOdds.gamingCompany) : hiloOdds.gamingCompany != null)
            return false;
        if (oddsHigh != null ? !oddsHigh.equals(hiloOdds.oddsHigh) : hiloOdds.oddsHigh != null) return false;
        if (oddsLow != null ? !oddsLow.equals(hiloOdds.oddsLow) : hiloOdds.oddsLow != null) return false;
        if (handicapLine != null ? !handicapLine.equals(hiloOdds.handicapLine) : hiloOdds.handicapLine != null)
            return false;
        if (oddsUpdateTime != null ? !oddsUpdateTime.equals(hiloOdds.oddsUpdateTime) : hiloOdds.oddsUpdateTime != null)
            return false;
        if (state != null ? !state.equals(hiloOdds.state) : hiloOdds.state != null) return false;
        if (score != null ? !score.equals(hiloOdds.score) : hiloOdds.score != null) return false;
        if (win310Id != null ? !win310Id.equals(hiloOdds.win310Id) : hiloOdds.win310Id != null) return false;
        if (durationTime != null ? !durationTime.equals(hiloOdds.durationTime) : hiloOdds.durationTime != null)
            return false;
        if (homeRedCard != null ? !homeRedCard.equals(hiloOdds.homeRedCard) : hiloOdds.homeRedCard != null)
            return false;
        if (europeId != null ? !europeId.equals(hiloOdds.europeId) : hiloOdds.europeId != null)
            return false;
        return !(awayRedCard != null ? !awayRedCard.equals(hiloOdds.awayRedCard) : hiloOdds.awayRedCard != null);
    ...
    public int hashCode() {
        ...
        result = 31 * result + (oddsHigh != null ? oddsHigh.hashCode() : 0);
        result = 31 * result + (oddsLow != null ? oddsLow.hashCode() : 0);
